...
def add(x: torch.Tensor, y: torch.Tensor):
    ...
    triton_runner.color_print.blue_print(f"debug {dump_tensor[debug_off: debug_off + BLOCK_SIZE]}")
    max_diff = torch.max(torch.abs(debug_torch[block_start: block_start + BLOCK_SIZE] - dump_tensor[debug_off: debug_off + BLOCK_SIZE]))
