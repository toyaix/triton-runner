...
- For Triton v3.7.0, in [examples/runner/v3.7.0](./v3.7.0).
- For Triton v3.6.0, in [examples/runner/v3.6.0](./v3.6.0).
- For Triton v3.5.x, in [examples/runner/v3.5.x](./v3.5.x).
- For Triton v3.4.0, in [examples/runner/v3.4.0](./v3.4.0).
