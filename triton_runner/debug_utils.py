...
def get_injected_ir_begin(original_line, indent, loc, python_dump):
...
def get_2d_injected_ir_with_encoding(ssa_value, original_line, indent, size, encoding, loc, python_dump):
    size_0, size_1 = size.split('x')
    encoding = encoding[2:]
    return f"""{get_injected_ir_begin(original_line, indent, loc, python_dump)}
