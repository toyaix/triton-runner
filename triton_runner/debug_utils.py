...
{indent}%debug_size_1_off       = arith.muli %debug_expand_1, %debuger_size_0_splat : tensor<32x1xi32> loc({loc})
{indent}%debug_broadcast_1      = tt.broadcast %debug_size_1_off : tensor<{size_1}x1xi32> -> tensor<{size}xi32> loc({loc})
